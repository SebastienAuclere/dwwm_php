...
class RestoRepository
{
    ...
    {                                             // La fonction est publique et retourne un tableau.
        ...
        } else {                                                                              // En résumé, cette fonction cherche un restaurant par son identifiant en utilisant une comparaison phonétique et retourne les informations du restaurant sous forme de tableau associatif, ou un tableau vide si aucun restaurant n’est trouvé.
    ...
    {                                                                                                                                      //La fonction est publique et retourne un booléen (true ou false)  
        ...
        echo $rq;                                                                                     // La requête SQL est affichée, probablement à des fins de débogage.
