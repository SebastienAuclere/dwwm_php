    ...
    <form action="" method="get" enctype="text/plain">                                     
            ...
            <div class="champ">
                ...
                <input type="text" id="password" max="50" name="password" 
                       value="<?php echo "khgkgkgjk"; ?>" class="champ2">         <!-- entree d'une valeur -->
            ...
            <div class="tailletab">
                ...
                echo $mylist->ajouterResteau("Burger King", "rue des Mimosas", 15, "C\'est pour les enfants", 5, "2024-05-06");  // Ajout d’un nouveau restaurant : Cette ligne appelle la méthode ajouterResteau de l’objet $mylist pour ajouter un nouveau restaurant avec les informations fournies 
